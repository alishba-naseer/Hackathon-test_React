...
//           {isLoggedIn && <span className="navbar-text mx-2 ">{userType.charAt(0).toUpperCase()} -</span>}
...
//             <div className="d-flex ms-auto"> {/* Aligns buttons to the right */}
//               {isLoggedIn ? (
//                 <button className="btn btn-danger mx-2" onClick={onLogout}>Logout</button>
//               ) : (
//                 <>
//                   <button className="btn btn-success mx-2" onClick={handleDoctorLoginClick}>Doctor Login</button>
//                   <button className="btn btn-success mx-2" onClick={handlePatientLoginClick}>Patient Login</button>
//                 </>
//               )}
//             </div>
//           </div>
...
//       {showDoctorForm && (
//         <DoctorLoginForm 
//           onSubmit={(name) => { onLogin('doctor', name); setShowDoctorForm(false); }}
//           onClose={() => setShowDoctorForm(false)} 
//         />
//       )}
//       {showPatientForm && (
//         <PatientLoginForm 
//           onSubmit={(name) => { onLogin('patient', name); setShowPatientForm(false); }}
